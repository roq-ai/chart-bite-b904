...
import { getStockChartById } from 'apiSdk/stock-charts';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Stock Chart Detail View
          </Text>
          {hasAccess('stock_chart', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/stock-charts/edit/${data?.id}`} passHref legacyBehavior>
              <Button
